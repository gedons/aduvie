<template>
    ...
    <!-- ===== userbooking Start ===== -->
    <section class="i pg fh rm ji gp uq mt-20 md:mt-0">
        <!-- Bg Shapes -->
                ...
                <div class="animate_top w-full nn/5 vo/3 vk sg hh sm yh tq">
                    <form @submit.prevent="bookEvent">
                        <div class="tc sf yo ap zf ep qb">
                            <div class="vd to/2">
                                <label class="rc ac">First name</label>
                                <input type="text" v-model="firstName" placeholder="Marc"
                                    class="vd ph sg zk xm _g ch pm hm dm dn em pl/50 xi mi" required />
                            </div>

                            <div class="vd to/2">
                                <label class="rc ac">Last name</label>
                                <input type="text" v-model="lastName" placeholder="Wonder"
                                    class="vd ph sg zk xm _g ch pm hm dm dn em pl/50 xi mi" required />
                            </div>
                        ...
                        <div class="tc sf yo ap zf ep qb">
                            <!-- <div class="vd to/2">
                                ...
                                <select id="eventId" v-model="eventId">
                                    <option>None</option>
                                    <option class="vd ph sg zk xm _g ch pm hm dm dn em pl/50 xi mi"
                            ...
                            <!-- <div class="vd to/2" v-if="selectedEvent">
                                <label class="rc ac" for="phone">Selected Event Date</label>
                                <input type="date" v-model="selectedEvent.date"
                                    class="vd ph sg zk xm _g ch pm hm dm dn em pl/50 xi mi" disabled required />
                            </div> -->
                            <div class="vd to/2">
                                <label class="rc ac" for="phone">Event Date</label>
                        ...
                        <div class="fb">
                            <label class="rc ac" for="message">Description</label>
    ...
    <footer>
        <div class="bb ze ki xn 2xl:ud-px-0">
                ...
                <div class="tc uf ap gg fp">
                    ...
                    <div class="vd ro tc sf rn un gg vn">
                        ...
                        <div class="animate_top">
                            ...
                            <p class="ac qe">Subscribe to receive updates</p>
            ...
            <div class="bh ch pm tc uf sf yo wf xf ap cg fp bj">
                ...
                <div class="animate_top">
                    <p>&copy; 2024 Aduvie Events. All rights reserved</p>
                </div>
            </div>
            <!-- Footer Bottom -->
        </div>
    ...
    methods: {
        ...
        async fetchEventDates() {
            try {
                ...
                // title: event.name,
                // start: event.date // Assuming 'date' field contains event date
                // }));
                //this.events = events;
            } catch (error) {
                console.error('Error fetching event dates:', error.response.data);
            }
        },
        toggleMenu() {
