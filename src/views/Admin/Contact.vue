                            ...
                            <div class="py-2 -my-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                                <div
                                    ...
                                    <table class="min-w-full">
                                        ...
                                        <div v-if="contactMessages.length === 0" class="p-2.5 xl:p-5">
                                            <p class="font-semibold text-sm leading-5 text-gray-700">No Contact Message
                                                Available!!!</p>
                                        </div>
                                        <tbody v-for="contact in contactMessages" :key="contact._id" class="bg-white">
                                            <tr>
        ...
        <div>
            ...
            <div id="modal-box4"
                ...
                <div v-if="isDeleteMode">
                    <p class="font-semibold">Are you sure you want to delete this message?</p>
                    <div class="flex gap-3">
                        <button class="bg-red-600 hover:bg-red-500 px-4 py-2 rounded-md mt-3 text-white"
                            @click="confirmDelete(contact)">Yes</button>
    ...
    methods: {
        ...
        async confirmDelete() {
            try {
                ...
                await axios.delete(`${api}/contacts/messages/${this.deleteContact._id}`, config)
                    .then((success) => {
                        if (success) {
                            ...
                            this.closeModal1();
                            const messageId = this.deleteContact._id;
                            this.contactMessages = this.contactMessages.filter(contact => contact._id !== messageId);
